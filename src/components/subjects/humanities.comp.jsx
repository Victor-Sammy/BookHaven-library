import humanImg from '../../assets/humanities.png'
import humanGif from '../../assets/humanities.gif'
import './subject.css'
import { useState } from 'react'

const HumanitiesComponent = () => {
  ...
  return (
    ...
    >
      <img
        ...
        src={isHovering ? humanGif : humanImg}
        alt=''
      />
      <h1
...
export default HumanitiesComponent
