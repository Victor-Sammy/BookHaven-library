import lifeImg from '../../assets/life_science.png'
import lifeGif from '../../assets/life-sciences.gif'
import './subject.css'
import { useState } from 'react'

const LifeScienceComponent = () => {
  ...
  return (
    ...
    >
      <img
        ...
        src={isHovering ? lifeGif : lifeImg}
        alt=''
      />
      <h1
...
export default LifeScienceComponent
